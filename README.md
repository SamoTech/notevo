...
> The open-source, zero-knowledge successor to Laverna. Built for 2026 with Next.js 15, TypeScript & AES-256-GCM encryption.
...
[Laverna](https://github.com/Laverna/laverna) was one of the best open-source encrypted note apps — 10k+ stars, beloved by the privacy community. It hasn't been updated since 2019 and has [438 open issues](https://github.com/Laverna/laverna/issues). Notevo is its spiritual successor: the same zero-knowledge encryption philosophy, rebuilt for 2026 with a modern stack, active maintenance, and a promise to stay **free forever**.
...
| | Feature | Details |
|---|---|---|
| 🔐 | **AES-256-GCM Encryption** | PBKDF2 key derivation (100k iterations). Your password never leaves your browser. |
| 📝 | **Full Markdown Editor** | Live split-pane preview. Bold, italic, headings, code, links — full syntax support. |
...
| ☁️ | **Optional Cloud Sync** | Supabase-backed sync (encrypted). Access your notes from any browser. |
...
| 🛡️ | **Privacy First** | No analytics, no trackers, no ads. [See Privacy Policy](https://notevo.vercel.app/privacy). |
...
One-click deploy — the fastest way to get your own Notevo instance:
...
Set your `NEXT_PUBLIC_SUPABASE_URL` and `NEXT_PUBLIC_SUPABASE_ANON_KEY` in the Vercel environment variables panel during setup.

---

## Pages & Legal

Notevo ships complete, production-ready legal and informational pages:
...
| Cookie & Storage Policy | `/cookies` | No tracking cookies · localStorage only · PECR compliant |
...
Notevo is free — and will stay free forever. But hosting, infrastructure, and development take real time and money.

If Notevo saves you time or protects your privacy, please consider supporting it:
...
**Good first issues** are labelled [`good first issue`](https://github.com/SamoTech/notevo/labels/good%20first%20issue) in the issue tracker.
